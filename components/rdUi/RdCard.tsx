...
function RdCard({ prefixtitle, title, attribution, excerpt, imgSrc, linkText, linkUrl, gradient, color }: RdCardProps) {
  return (
    <div
      className={clsx(
        ...
        { "from-[#72aeff] to-[#377ddb]": gradient === "blue", "from-[#42202e] to-[#42202e]": gradient === "pinkDark" }
      )}
    >
