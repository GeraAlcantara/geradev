...
excerpt: Usamos chatGPT para obtener recomendaciones sobre como refactorizar un código de ES5 a TypeScript en un paradigma OOP y mejorar el codigo para el manejo de errores y crear algo de type narrowing con interfaces y genéricos, las respuestas que nos dio fueron satisfactorias para darnos una idea que que pasos teniamos que realizar en el proceso de refactorización.
