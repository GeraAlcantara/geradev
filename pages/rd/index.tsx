...
const rdCardsData: RdCardComponentProp[] = [
  ...
  },
  {
    ...
    prefixtitle: "Experimento",
    title: "Con Modelos 3D",
    excerpt: "Realizando experimentos en el navegador con modelos 3D, en este caso renderiamos el modelo con un loop de animación",
    imgSrc: AirplaneImg,
    linkText: "visitar experimento",
    ...
    color: "dark",
    attribution: {
      baseonUrl: "https://sketchfab.com/3d-models/stylized-airplane-the-flying-circus-diorama-cbb8d5ed7fd745e3a5b9af7ae3ab9b42",
