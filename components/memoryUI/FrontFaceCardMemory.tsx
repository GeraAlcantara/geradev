...
function FrontFaceCardMemory(props: ItemImgCard): JSX.Element {
  return (
    <div className="front-face h-full overflow-hidden ">
      <div className="memory-card__wrapper ">
        {/* top part */}
        <div className=" absolute inset-0 w-1/2 h-1/2 opacity-50 gradient gradient__glow col-start-1 col-end-4 row-start-1 row-span-4" />
        ...
        <div className="memory-card__center">
          <div className="memory-card__Icon  ">
            <Image alt="" draggable={false} layout="fill" src={props.img} />
          </div>
        </div>
